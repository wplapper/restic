...
func do_check(repo restic.Repository, ctx context.Context,
	ReadallOptions readall_options, checked_packs map[string]bool, repo_packs map[restic.ID]int64) error {
...
func ReadStatsFile(repo restic.Repository, ctx context.Context,
	handle restic.Handle) (map[string]bool, error) {
